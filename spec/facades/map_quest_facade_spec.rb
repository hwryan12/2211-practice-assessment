  ...
  describe 'instance methods' do
    describe '#directions' do
      it 'returns a directions object' do
        ...
        expect(directions.directions).to eq("Head east on W 25th Ave. Go for 246 ft./nTurn right onto Sheridan Blvd (CO-95). Go for 0.4 mi./nTurn right onto W 20th Ave. Go for 0.2 mi./nTurn right onto Depew St. Go for 174 ft./nArrive at Depew St.")
      end
    end
  end
end